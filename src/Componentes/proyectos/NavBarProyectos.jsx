  ...
  return (
    <>
         <nav ref={volverArriba}  className='flex item-center justify-around flex-wrap p-3 '>
           ...
           <button onClick={handleBack} className='flex items-center font-roboto font-bold px-2 hover:scale-90 border-l-2 border-third transition-all duration-500 text-center'>
           <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-arrow-narrow-left text-center w-14 h-8">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M5 12l14 0" />
                <path d="M5 12l4 4" />
                <path d="M5 12l4 -4" />
