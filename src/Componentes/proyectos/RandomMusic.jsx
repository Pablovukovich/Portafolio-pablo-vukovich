          ...
          <a href="#" className="absolute w-32 h-14 z-10 bg-quinto flex justify-center items-center text-second font-roboto font-bold hover:bg-primary hover:text-third transition-all duration-500  ">VER PROYECTO</a>
            ...
            <div className='bg-quarter w-[80%] h-[90%] sm:w-[60%]  mx-10 shadow-2xl relative overflow-y-auto my-2 scrollbar-thin scrollbar-thumb-second scrollbar-track-primary '>
                ...
                <div className='px-5 py-2  my-2 '>
                  ...
                  <p><span className='font-medium '>Exploración Aleatoria de Canciones:</span> Con un solo clic, la app selecciona y reproduce una canción al azar de un extenso catálogo, permitiendo a los usuarios descubrir música de diferentes géneros, épocas y estilos.<br/>
                    <span className='font-medium'>Detalles de Canción y Artista:</span> Cada canción incluye información detallada sobre el título, artista, álbum, y otros detalles relevantes. Los usuarios pueden conocer más sobre la canción y acceder a enlaces para escucharla en plataformas de streaming.<br/>
