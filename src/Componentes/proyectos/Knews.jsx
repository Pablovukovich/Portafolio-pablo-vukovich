...
export const Knews = () => {
  return (
    <>
        <NavBarProyectos/>
        <div className='flex flex-col sm:flex-row justify-center items-center m-10 sm:m-20 dark:bg-sexto'>
            ...
            <div className='h-full w-full mx-1 sm:w-[70%] sm:mx-10 font-roboto'>
              <p className='font-medium text-start text-xl dark:text-quarter'><span className='text-2xl font-extrabold'>Knews</span> es un proyecto  enfocado principalmente en <span className='text-2xl font-extrabold text-quinto'>Blackpink</span> y 
        ...
        <div className='flex flex-col justify-center items-center dark:bg-sexto'>
          <a href="https://www.instagram.com/knews.bp/" >
              ...
              <div className='h-full w-auto my-3 '>
                <p className='dark:text-quarter'> Creado en Febrero del 2024 por Pablo Vukovich</p>
              </div>
        </div>
