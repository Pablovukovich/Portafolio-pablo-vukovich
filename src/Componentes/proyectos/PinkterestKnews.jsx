...
export const PinkterestKnews = ({ proyecto }) => {
  ...
  return (
    <>
         <NavBarProyectos   />
         <section   className='flex flex-col items-center sm:items-stretch sm:flex-row  h-auto sm:h-screen '>
        <div className="my-5 mx-14 w-[80%] h-full sm:w-[40%] sm:h-[95%] bg-quarter shadow-2xl relative flex justify-center items-center group ">
          ...
          <a href="#" className="absolute w-32 h-14 z-10 bg-quinto flex justify-center items-center text-second font-roboto font-bold hover:bg-primary hover:text-third transition-all duration-500  ">VER PROYECTO</a>
            ...
            <div className='bg-quarter w-[80%] h-[90%] sm:w-[60%] sm:h-auto  mx-10 shadow-2xl relative overflow-y-auto my-2 scrollbar-thin scrollbar-thumb-second scrollbar-track-primary   '>
                ...
                <div className='px-5 py-2  my-2 '>
                  ...
                  <p><span className='font-medium '>Interfaz de Usuario Dinámica:</span> La aplicación contará con una disposición de tipo grid al estilo de Pinterest, donde cada imagen se adapta automáticamente al espacio disponible. Los usuarios podrán desplazarse infinitamente, disfrutando de una navegación fluida.<br/>
                    <span className='font-medium'>Organización Personalizada:</span> Los usuarios podrán crear colecciones personalizadas para organizar sus imágenes preferidas, lo que les permitirá agrupar y acceder fácilmente a su contenido favorito.<br/>
                    <span className='font-medium'>Detalles Interactivos:</span> Al seleccionar una imagen, se desplegará una vista detallada que permitirá ver la imagen en alta resolución y acceder a opciones adicionales, como compartir en redes sociales o agregarla a colecciones personales.</p>
                    <br />
                    <span className='font-semibold text-lg'>Tecnologías Utilizadas</span>
                  <p><span className='font-medium'>Frontend:</span> Construido con React y estilizado con Tailwind CSS, asegurando una experiencia visual moderna y rápida respuesta a interacciones del usuario. <br />
                  <span className='font-medium'>Backend:</span> Implementado con Java y Spring Boot, lo cual garantiza un backend robusto y escalable para la gestión de usuarios, colecciones y almacenamiento de imágenes.</p>
                  <br/>
                  <span className='font-semibold text-lg'>Objetivo</span>
                  <p>El propósito de esta aplicación es brindar una plataforma única para los fans de Blackpink, donde puedan explorar y descubrir contenido visual en un entorno que combine funcionalidad y estética. Además, busca perfeccionar habilidades en React, Tailwind y Spring Boot, consolidando el desarrollo tanto en frontend como en backend.</p>
                </div>
