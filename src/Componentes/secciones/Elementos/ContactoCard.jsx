...
const ContactoCard = () => {
  ...
  return (
    <div className="min-h-auto  text-[#FCDDE4] my-10 w-2/6 flex items-center justify-center dark:bg-sexto">
      <div className="p-6 bg-[#EECFD7] rounded-2xl shadow-lg w-full  text-center flex flex-col items-center dark:bg-third">
        <h2 className="text-2xl font-bold text-quinto mb-4">Contactame</h2>
        <p className="text-lg text-[#8E4256] mb-6">I'd love to hear from you!</p>
